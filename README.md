# Repolex Knowledge Graph of browserify/browserify

RDF knowledge graph data for [browserify/browserify](https://github.com/browserify/browserify), parsed by [repolex](https://repolex.ai).
...
```bash
lexq download browserify/browserify
```
...
└── blob
    ...
    └── 8f617288f1f7f808c2f387acb694c7251b96b14f.nq.gz
